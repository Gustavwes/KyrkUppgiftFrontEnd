...
function getForm() {
    ...
    var frm = "<div class='row justify-content-center'>"
    ...
    frm+="<div class='col-2 pt-5'><p>När du skickat din bokning kommer du att få ett mail som bekräfar din bokning där du också kommer att få all info du behöver för att betala bokningen, hur du tillträder(nyckel etc). Bekräftelsemailet kan ta ngn eller några dagar men ditt bokningsdatum avgör turordningen</p></div>";
    frm+= "<div class='col-2 pt-3'><h3>Hyresvärd</h3>";
    array2.forEach(x=>{
        frm+=`<p>${x}</p>`;
    });
